...
public class ChaosModeBossNameSystem : ModSystem
{
    ...
    public static int TypingTimer;
    public static string FullBossName = "";
    public static int TypingIndex;
    ...
    private void DrawBossName()
    {
        ...
        Vector2 position = new(centerX - textSize.X / 2, centerY);
        ...
        Vector2 shadowPos = new(position.X + 4, position.Y + 4);
